...
// ALERT_THRESHOLD (85), a Verdict is produced and written to
// a JSONL file under <exeDir>\Verdicts\.
//
...
// Thresholds used by VerdictWriter::decideVerdict
// P1-3: 与 behavior_engine.h 中的 ALERT_THRESHOLD(85)/WARN_THRESHOLD(40) 保持一致
constexpr int VERDICT_ALERT_THRESHOLD = 85;
constexpr int VERDICT_WARN_THRESHOLD = 40;
