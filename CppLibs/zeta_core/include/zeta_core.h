...
const unsigned long ZETA_MSG_APC_INJECT = 6010;  // NtQueueApcThread 注入拦截
...
const unsigned long ZETA_CMD_SET_PROCESS_PROTECT = 8;
const unsigned long ZETA_CMD_SET_SUSPEND_ENABLE = 9;
const unsigned long ZETA_CMD_SET_FILE_PROTECT = 10;
const unsigned long ZETA_CMD_SET_SYSTEM_PROTECT = 11;
const unsigned long ZETA_CMD_SET_DRIVER_PROTECT = 12;
const unsigned long ZETA_CMD_SET_NETWORK_PROTECT = 13;
const unsigned long ZETA_CMD_SET_LEARNING_MODE = 14;
const unsigned long ZETA_CMD_RELOAD_RULES = 15;
const unsigned long ZETA_CMD_SET_AUDIT_MODE = 16;
const unsigned long ZETA_CMD_QUERY_AUDIT_LOG = 17;
// P0-1: ZETA_CMD_ROLLBACK_MARK 8→18 避免与 SET_PROCESS_PROTECT 冲突
const unsigned long ZETA_CMD_ROLLBACK_MARK = 18;
const unsigned long ZETA_CMD_SET_APC_HOOK = 19;  // enable NtQueueApcThread hook
